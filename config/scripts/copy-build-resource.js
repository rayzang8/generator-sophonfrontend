...
const basePath = require('../webpack/dev.server').federationName;
...
const srcAssets = path.resolve('src/assets/public');
const dst = path.resolve(`build/${basePath}/assets/public`);
